...
import {ArrowLeftIcon, Briefcase, ChevronLeft, ChevronRight, DownloadIcon, EyeIcon, EyeOff, FileText, GraduationCap, Share2Icon, Sparkles, User} from 'lucide-react'
...
import api from '../../public/configs/api'
     ...
     <div className='max-w-7xl mx-auto px-4 pb-8'>
      <div className='grid lg:grid-cols-12 gap-8'>
            ...
            <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1'>
              <div className='flex items-center gap-2'>
                <TemplateSelector selectedTemplate={resumeData.template} onChange={(template)=> setResumeData(prev => ({...prev,template}))}/>
                  <ColorPicker onChange={(color)=> setResumeData(prev => ({...prev,accent_color:color}))} selectedColor = {resumeData.accent_color} />
              </div>
        ...
        <div className='relative w-full'>
          ...
          justify-end gap-2'>
            {resumeData.public && (
              <button onClick={handleShare} className='flex items-center p-2 px-4 gap-2
            ...
            <button onClick={downloadResume} className='flex items-center p-2 px-4 gap-2
              text-xs bg-gradient-to-br from-green-100 to-green-200 text-green-600
