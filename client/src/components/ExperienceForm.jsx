...
const ExperienceForm = ({ data, onChange }) => {
    ...
    return (
        <div className='space-y-6'>
            ...
            px-3 py-1 text-sm bg-green-100
                        ...
                        rounded-lg space-y-3'>
                            ...
                            <div className='grid md:grid-cols-2 gap-3'>
                                ...
                                <input value={experience.start_date || ""} onChange={(e) => updateExperience(index, "start_date", e.target.value)} type="month"
                                    className='px-3 py-2 text-sm rounded-lg'
                                />
                                <input value={experience.end_date || ""} onChange={(e) => updateExperience(index, "end_date", e.target.value)} type="text" disabled={experience.is_current}
                            ...
                            <div className='space-y-2'>
                                ...
                                <textarea value={experience.description || ""} rows={4}
                                    onChange={(e) => updateExperience(index, "description", e.target.value)} className='w-full text-sm px-3 py-2 rounded-lg resize-none'
